...
输出：
    ...
    2.Model_select：模式选择（外部获取：Model_select.get()）
    3.LOAD_BOOL：是否导入Bool值 (外部获取：LOAD_BOOL.get())
    4.ISLOAD：是否导入（外部获取：ISLOAD.get()）
"""
