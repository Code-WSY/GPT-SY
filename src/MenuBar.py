...
filemenu_mode.add_radiobutton(label="对话模式", variable=selected_mode, value="对话模式")
filemenu_mode.add_radiobutton(label="导入模式", variable=selected_mode, value="导入模式")
#selected_mode.set("对话模式")

def change_UI():
    if selected_mode.get() == "对话模式":
        foget_all()
        chat_UI()
    elif selected_mode.get() == "导入模式":
        foget_all()
        load_UI()
